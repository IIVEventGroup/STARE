...
def run(settings):
    ...
    settings.val_samples_per_epoch = 2500
    ...
    dataset_train = sampler.DiMPSampler([FE240_train], [1],
    ...
    dataset_val = sampler.DiMPSampler([fe240_val], [1], samples_per_epoch=settings.val_samples_per_epoch,
