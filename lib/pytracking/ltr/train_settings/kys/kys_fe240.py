...
import os
from ltr.dataset import Lasot, Got10k, TrackingNet, ESOT500, FE240
...
def run(settings):
    ...
    dataset_train = sampler.KYSSampler([fe240_train],
                                       [1],
    ...
    dataset_val = sampler.KYSSampler([fe240_val], [1], samples_per_epoch=1000,
