...
from ltr.dataset import Lasot, TrackingNet, MSCOCOSeq, Got10k, ESOT500, FE240
...
def run(settings):
    ...
    settings.description = 'ATOM IoUNet with default settings, trained on ESOT500.'
    ...
    dataset_train = sampler.ATOMSampler([esot500_train], [1],
                                samples_per_epoch=250*settings.batch_size, max_gap=50, processing=data_processing_train)
    ...
    dataset_val = sampler.ATOMSampler([fe240_val], [1], samples_per_epoch=500*settings.batch_size, max_gap=50,
