...
def parameters():
    ...
    params.target_candidate_matching_net = NetWrapper(net_path='/home/test4/code/EventBenchmark/lib/pytracking/ltr/checkpoints/checkpoints/ltr/keep_track/JieChu_esot500/keep_track_ep0015.pth.tar', use_gpu=params.use_gpu)
