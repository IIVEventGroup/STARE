...
def parameters():
    ...
    deep_feat = deep.ATOMResNet18(net_path='/home/test4/code/EventBenchmark/lib/pytracking/ltr/checkpoints/checkpoints/ltr/bbreg/atom_fe240/ATOMnet_ep0050.pth.tar', output_layers=['layer3'], fparams=deep_fparams, normalize_power=2)
