...
def parameters():
    ...
    params.net = NetWithBackbone(net_path='/home/test4/code/EventBenchmark/lib/pytracking/ltr/checkpoints/checkpoints/ltr/tomp/JieChu_tomp50_esot500/ToMPnet_ep0300.pth.tar', use_gpu=params.use_gpu)
