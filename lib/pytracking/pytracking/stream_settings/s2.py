...
def parameters():
    ...
    params.sim = False
    params.sim_runtime = 20*1e3 # unit:us # TODO seperate according to tracker
    params.sim_disturb = 0.1 # disturbance around runtime
    ...
    '''User-define Part'''
    # Slicing
    params.slicing = 'FxNum' # FxTime, FxNum, Adaptive, Last
    params.window_size = 50*1e3 # unit:us
    params.window_size_template = 30*1e3 # unit:us
